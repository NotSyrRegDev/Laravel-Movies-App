        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%;" >
                    <iframe src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key'] }}" style="border: 0;" frameborder="0" class="responsive-iframe absolute top-0 left-0 w-full h-full" allow="autoplay; encrypted-media" allowfullscreen ></iframe>
                </div>
                </div>
                </div>
                </div>
